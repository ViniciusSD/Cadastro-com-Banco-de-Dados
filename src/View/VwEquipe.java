...
public class VwEquipe extends javax.swing.JFrame {
    ...
    private void jButtonSalvarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonSalvarMouseClicked
        // TODO add your handling code here:
        Equipe equi = MontaEquipe();
        equi.setId(ctrl.getUltimoId() + 1);
        if (ctrl.Inserir(equi)) {
            JOptionPane.showMessageDialog(this, "Equipe inserida com sucesso.");
            jButtonAbrirMouseClicked(evt);
            ...
            JOptionPane.showMessageDialog(this, "Erro ao inserir equipe.");
        }
        ...
        if (ctrl.CriaConexao()) {
            if (ctrl.ConsultarTodos()) {
                if (JDBCUtil.MovPrimeiro(ctrl.getRsdados())) {
                    Equipe equipe = ctrl.getEquipe();
                    if (equipe != null) {
                        Nav(equipe);
                    } else {
                        JOptionPane.showMessageDialog(this, "Equipe retornada é nula.");
                        LimpaCampos();
                    }
                }
            }
    ...
    private void jButtonBuscaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonBuscaMouseClicked
        ...
        try {
            ...
            Equipe equipe = ctrl.getEquipePorId(aux);
            if (equipe == null) {
    ...
    private void jButtonDelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonDelMouseClicked
        ...
        try {
            Equipe equi = MontaEquipe();
            System.out.println("Equipe: " + equi.getId() + equi.getNome() + equi.getChefe());
            System.out.println("Id: " + equi.getId());
            if (ctrl.Excluir(equi)) {
                JOptionPane.showMessageDialog(this, "Equipe excluida com sucesso. \nReiniciando a navegacao.");
                jButtonAbrirMouseClicked(evt);
            } else {
    ...
    private void jButtonEditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonEditMouseClicked
        ...
        Equipe equi = MontaEquipe();
        int temp = equi.getId();
        if (ctrl.Alterar(equi)) {
            JOptionPane.showMessageDialog(this, "Equipe alterada com sucesso.");
            jButtonAbrirMouseClicked(evt);
            Buscar(temp);
        } else {
            JOptionPane.showMessageDialog(this, "Erro ao alterar equipe.");
        }
    }//GEN-LAST:event_jButtonEditMouseClicked

    public void Nav(Equipe equipe) {
    ...
    public Equipe MontaEquipe() {
        ...
        String chefe = jTextFieldChefe.getText();
        String sede = jTextFieldSede.getText();
        int ano = Integer.valueOf(jTextFieldAno.getText());
        String carro = jTextFieldCarro.getText();
        int vitorias = Integer.valueOf(jTextFieldVit.getText());
    ...
    public void LimpaCampos() {
        ...
        jTextFieldChefe.setText("");
        jTextFieldSede.setText("");
        jTextFieldAno.setText("");
        jTextFieldCarro.setText("");
        jTextFieldVit.setText("");
    }
